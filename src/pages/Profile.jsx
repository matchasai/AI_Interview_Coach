  ...
  return (
    <div className="mx-auto max-w-xl">
      <Card>
        ...
        {success ? (
          <p className="mb-3 rounded-md border border-emerald-500/30 bg-emerald-500/10 px-3 py-2 text-sm text-emerald-700 dark:text-emerald-200">
            {success}
          </p>
        ) : null}
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <label className="flex items-start gap-3 rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#1e293b]/70 p-4 text-sm text-slate-600 dark:text-gray-300">
            <input
              type="checkbox"
