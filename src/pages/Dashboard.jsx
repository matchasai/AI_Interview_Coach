...
export function Dashboard() {
  ...
  return (
    <Motion.div className="space-y-6" variants={stagger} initial="initial" animate="animate">
      <Motion.section variants={fadeUp} className="glass-hero surface-glow relative overflow-hidden p-5 md:p-7">
        ...
        <div className="relative z-10 flex flex-wrap items-center justify-between gap-3">
          <div>
            <p className="inline-flex rounded-full bg-indigo-500/20 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-indigo-700">
              Insights hub
            </p>
          ...
          <Card>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {studyGuides.slice(0, 4).map((guide) => (
                <div key={guide.role} className="saas-card p-4">
            ...
            <div className="mb-4 flex flex-wrap gap-3 border-b border-slate-200 pb-4">
              <div>
                ...
                <select
                  ...
                  className="mt-1 rounded-xl border border-slate-200 bg-white px-2.5 py-1.5 text-sm text-slate-900 shadow-sm transition focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/50"
                >
                ...
                <table className="w-full text-left text-sm">
                  ...
                  <tbody className="text-slate-700">
                    {filteredSessions.slice(0, 15).map((s) => (
                      <tr key={s._id} className="border-t border-slate-200 transition-colors hover:bg-slate-50">
                          ...
                          <div className="flex items-center justify-end gap-3">
                            {s.status === 'completed' ? (
                              <Link
                                ...
                                className="rounded-md px-1 text-slate-700 transition hover:bg-indigo-500/20 hover:text-indigo-700 hover:underline"
                              >
                                View
                              </Link>
                            ) : (
          ...
          <Card>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm">
                ...
                <tbody className="text-slate-700">
                  {stats.perRole.map((r) => (
                    <tr key={r.role} className="border-t border-slate-200">
