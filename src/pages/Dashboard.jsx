              ...
              {studyGuides.slice(0, 4).map((guide) => (
                <div key={guide.role} className="saas-card p-4">
                  ...
                  <div className="mt-3 space-y-3 text-sm text-slate-600 dark:text-gray-400">
                    ...
                    <div className="rounded-xl border border-slate-200 dark:border-white/10 bg-slate-100 dark:bg-[#273549] px-3 py-2 text-xs text-slate-600 dark:text-gray-300">
                ...
                <table className="w-full text-left text-sm">
                  ...
                  <tbody className="text-gray-200">
                    {filteredSessions.slice(0, 15).map((s) => (
                      <tr key={s._id} className="border-t border-slate-200 dark:border-white/10 transition-colors hover:bg-slate-100 dark:hover:bg-slate-100 dark:bg-[#273549]">
                        ...
                        <td className="py-2 text-right">
                          <div className="flex items-center justify-end gap-3">
                            ...
                            {(s.status === 'active' || s.status === 'paused') ? (
                              <Button
                                variant="ghost"
                                className="px-2 py-1 text-xs text-red-700 hover:text-red-800 dark:text-red-300 dark:hover:text-red-200"
