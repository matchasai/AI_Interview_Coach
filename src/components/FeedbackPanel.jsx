      ...
      <div className="space-y-3">
        ...
        <div>
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex rounded-lg border border-slate-200/80 bg-white/90 p-0.5 text-xs">
              {['short', 'long', 'bullets'].map((f) => (
                <button
                  ...
                  className={`rounded-md px-2 py-1 transition ${
                    answerFormat === f ? 'bg-indigo-600 text-slate-900' : 'text-slate-600 hover:bg-slate-50'
                  }`}
                >
                  {f}
                </button>
              ...
              {!evaluation.evidence?.length ? (
                ...
                <div className="mt-1 space-y-2">
                  {evaluation.evidence.map((item, idx) => (
                    <div key={idx} className="rounded-lg border border-slate-200/80 bg-white/90 p-2 text-sm">
