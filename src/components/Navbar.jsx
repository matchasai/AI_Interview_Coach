...
function navClass({ isActive }) {
  return `rounded-xl px-3 py-2 text-sm font-medium transition-all duration-300 ${
    isActive
      ? 'bg-gradient-to-r from-indigo-500/25 to-purple-600/25 text-slate-900 ring-1 ring-indigo-300/70 shadow-md shadow-indigo-900/20'
...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-slate-200/70 bg-white/65 backdrop-blur-md">
