    ...
    <Card>
      ...
      {topicOverview ? (
        <div className="mt-3 rounded-xl border border-indigo-400/30 bg-indigo-500/15 px-3 py-2">
          <p className="text-xs font-semibold uppercase tracking-wide text-indigo-700 dark:text-indigo-200">Topic overview</p>
          <p className="mt-1 text-sm text-slate-800 dark:text-gray-200">{topicOverview}</p>
        </div>
      ) : null}
      ...
      {realWorldExample ? (
        <div className="mt-3 rounded-xl border border-emerald-400/30 bg-emerald-500/15 px-3 py-2">
          ...
          <p className="mt-1 text-sm text-slate-800 dark:text-gray-200">{realWorldExample}</p>
        </div>
      ) : null}
      ...
      {programmingUsage ? (
        <div className="mt-3 rounded-xl border border-violet-400/30 bg-violet-500/15 px-3 py-2">
          <p className="text-xs font-semibold uppercase tracking-wide text-violet-700 dark:text-violet-200">Programming usage</p>
          <p className="mt-1 text-sm text-slate-800 dark:text-gray-200">{programmingUsage}</p>
        </div>
      ) : null}
    </Card>
  )
