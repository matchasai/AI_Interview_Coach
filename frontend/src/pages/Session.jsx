      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-600">
            {session.role} · {session.difficulty} · {answeredCount}/{totalQuestions} answered · Elapsed{' '}
            {formatElapsed(elapsed)}
            {session.status === 'paused' && <span className="ml-2 text-amber-600 font-medium">(Paused)</span>}
          </p>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="space-y-4">
          ...
          <Card>
            ...
            <textarea
              className="min-h-40 w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-100 disabled:bg-slate-50 disabled:text-slate-500"
